class Start {
	...
	load() {
		...
		let babyLeftSpriteSheet = new createjs.SpriteSheet(babyLeftData);
		...
		this.babyLeft.on(
			'click',
			evt => (window.location.href = window.location.href.split('/start')[0] + '/pattern/sad/')
		);
		...
		let babyRightSpriteSheet = new createjs.SpriteSheet(babyRightData);
		...
		this.babyRight.on(
			'click',
			evt => (window.location.href = window.location.href.split('/start')[0] + '/pattern/happy/')
		);
